...
function validateResult(result) {
  ...
  if (result.question_text.includes('[')) throw new Error('question_text still contains brackets');
}
...
async function main() {
  console.log('Fetching grammar questions with bracketed word choices...');
