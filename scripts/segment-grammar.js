/**
 * segment-grammar.js
 * Similar to segment-punctuation.js but for grammar category.
 * Adds A/B/C/D/N segment options to grammar reference questions
 * that have no options yet.
 *
 * Usage: node scripts/segment-grammar.js
 */
...
Segment this SEAG grammar question into A/B/C/D/N parts.
...
async function main() {
  console.log('Fetching grammar reference questions with no options...');
